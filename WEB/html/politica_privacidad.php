...
<html lang="en">
  <head>
    <title>Política de Privacidad RA</title><!-- título-->
    ...
    <link rel="stylesheet" href="../css/politica_privacidad.css" type="text/css"> <!--Enlace externo a CSS-->
  </head>
  <body>
    ...
    <div class="container">
        ...
        <header>
          ...
          <div class="col-md-12 col-xs-12 " id="privacidad"> <a href="aviso_legal.php" id="aviso_legal">Aviso Legal</a> | <a href="politica_privacidad.php" id="politica_privacidad">Política de privacidad</a> | <a href="ayuda.php" id="ayuda"> Cookies</a></div>
        </footer>
      <script type="text/javascript" src="../js/ayuda.js"></script> <!--Enlace externo a archivo JS-->
    </div> 
  </body>
</html>
