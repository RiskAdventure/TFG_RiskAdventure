  ...
  <body>
    ...
    <div class="container">
        ...
        <header>
          ...
          <div class="col-md-12 col-xs-12 " id="privacidad"> <a href="aviso_legal.php" id="aviso_legal">Aviso legal</a> | <a href="politica_privacidad.php">Politica de privacidad</a> | <a href="ayuda.php"> Ayuda</a></div>
        </footer>
