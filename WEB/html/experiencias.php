...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../css/experienciass.css" type="text/css"> <!--Enlace externo a CSS-->
  </head>
  <body>
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 borde1"> <p>uno</p> </div>
          <div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 borde1"> <p>dos</p> </div>
          <div class="col-12 col-sm-12 col-md-6 col-lg-2 col-xl-2 borde1"> <p>tres</p> </div>
      ...
      <script type="text/javascript" src="../js/experiencias.js"></script> <!--Enlace externo a archivo JS-->
    </div> 
  </body>
</html>