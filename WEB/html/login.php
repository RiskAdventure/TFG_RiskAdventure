...
<html lang="en">
  <head>
    <title>Login Risk Adventure</title><!-- título-->
    ...
    <link rel="stylesheet" href="../css/login.css" type="text/css"> <!--Enlace externo a CSS-->
  </head>
  <body>
    ...
    <div class="container">
      ...
      <script type="text/javascript" src="../js/login.js"></script> <!--Enlace externo a archivo JS-->
    </div> 
  </body>
</html>