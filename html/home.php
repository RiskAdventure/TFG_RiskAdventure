...
<body>
  <header>
    ...
    <ul>
      ...
      <li ><a id="experiencias">EXPERIENCIAS</a></li>
      <li ><a id="eventos">EVENTOS EMPRESA</a></li>
      <li ><a id="packs">PACKS & GRUPOS</a></li>
      <li ><a id="sobre">NOSOTROS</a></li>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item active">
        <img src="../imagenes/man-5983064_1280.webp" alt="Los Angeles" >
